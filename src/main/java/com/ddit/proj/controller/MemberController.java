...
//		model.addAttribute("memberList", data);
		...
		ArticlePage<MemberVO> a = new ArticlePage<MemberVO>(total, currentPage, size, data);
		model.addAttribute("data", new ArticlePage<MemberVO>(total, currentPage, size, data));
		List<MemberVO> memberList = a.getContent();
...
//			log.info("체킁:");
//			
//			List<MemberVO> data = this.memberSerivce.listMember();
//			log.info("data : " + data);
//			
//			model.addAttribute("memberList", data);
//			
//			int total = this.memberSerivce.getMemberListTotal(map);
//			log.info("체킁 total : " + total);
//			
//			List<MemberVO> dataP = this.memberSerivce.listMemberPage(map);
//			model.addAttribute("dataP", new ArticlePage<MemberVO>(total, currentPage, size, dataP));
//			
//			//forwarding
//			return "member/memberList";
//		}
	...
	public String register(@RequestBody MemberVO memberVO) {
		//memberVO : MemberVO(rnum=0, memNo=1, memPass=null, memDelYn=null, memNm=2, memNme=null, memTel=4, 
